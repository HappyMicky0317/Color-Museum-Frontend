            ...
            baseColor.map((item, index) => {
              ...
              arr.map((i, index) => {
                dataContent.push({
                  id: index,
                  color: (
                    <Link href={`/theblockstaging/${i.uint256}`} passHref>
                      <div
                  ...
                  hexadecimal: (
                    <Link
                      href={`/theblockstaging/${i.uint256}`}
                      style={{
                ...
                return (
                  <div className={stylesSecond.dataTableContainer} key={index}>
                    ...
                    <DataTable
                      ...
                      pointerOnHover={true}
                      onRowClicked={(row) => {
                        history.push(`/theblockstaging/${row.tokenID}`);
                      }}
                    />
                  </div>
                );
            ...
            baseColor.slice(0, amountShowed).map((item, index) => {
              ...
              arr.map((i, index) => {
                dataContent.push({
                  ...
                  name: i.name,
                  hexadecimal: (
                    <Link href={`/theblockstaging/${i.uint256}`}>
                      <a
                        style={{
                          textTransform: "uppercase",
                          textDecoration: "none",
                  ...
                  <article className={stylesSecond.mainGrid}>
                    {arr.map((item, index) => {
                      if (
                        ...
                        return (
                          <Link href={`/theblockstaging/${item.uint256}`} key={index}>
                            <a
